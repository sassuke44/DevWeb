...
// }
// inputsegunda= q
// inputsegunda.addEventListener("keyup", add)
// inputterca.addEventListener("keyup", add)
// inputquarta.addEventListener("keyup", add)
// inputquinta.addEventListener("keyup", add)
// inputsexta.addEventListener("keyup", add)   
...
//       case 'segunda':
//         dias_semana.segunda_refeicao.push(inputNamesegunda.value);
//         clearInput();
//         break;
//       case 'terça':
//         dias_semana.terca_refeicao.push(inputNamesegunda.value);
//         clearInput();
//       case 'quarta':
//         dias_semana[0].refeicao.push(inputNamesegunda.value);
//         clearInput();
//         break;
//       default:
//        comsole.log(dias_semana)
//     }
//   }
// }
